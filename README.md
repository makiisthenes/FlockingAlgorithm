...
<ul>
  ...
  <hr>
<h3>Final Notice</h3> 
<i>There are of course many more challenging concepts that do pose a challenge for me in which I did attempt to approach in test.py file, these include:</i>
  <ul>
